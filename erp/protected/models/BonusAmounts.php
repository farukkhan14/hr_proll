...
class BonusAmounts extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('bonus_id, employee_id, amount, date, is_active', 'required'),
            ...
            array('id, bonus_id, employee_id, amount, date, is_active, is_approved, create_by, create_time, update_by, update_time', 'safe', 'on' => 'search'),
        );
    }
