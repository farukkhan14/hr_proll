<fieldset>
    ...
    <table class="reportTab">
        ...
        <tr>
            ...
            <td class="textAlgnLeft">Sub-Section</td>
            <td><?php echo SectionsSub::model()->nameOfThis($model->sub_section_id); ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="textAlgnLeft">Paygrade- <?php echo PayGrades::model()->nameOfThis($model->paygrade_id); ?></td>
            <td colspan="3">
                <?php
