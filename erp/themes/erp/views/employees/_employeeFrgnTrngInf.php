<fieldset>
    <legend>Foreign Training Informations</legend>
    <table>
        <tr>
            <td style="text-align: center;"><?php echo $form->labelEx($model, 'frgn_trng_inf'); ?></td>
        </tr>
        <tr>
            <td>
                <?php
                if($model->frgn_trng_inf){
                    
                }else{
                    $model->frgn_trng_inf='<table border="1" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<th style="width: 106px; text-align: center; vertical-align: middle;"><strong>Title</strong></th>
			<th style="width: 106px; text-align: center; vertical-align: middle;"><strong>Country</strong></th>
