    ...
    <fieldset>
        ...
        <table>   
            ...
            <tr>
                ...
                <td><?php echo $form->checkBox($model, 'is_basic_salary'); ?></td>            
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                ...
                <td><?php echo $form->checkBox($model, 'is_provident_fund'); ?></td>            
            </tr>
            <tr>
                <td></td>
...
<script>
    $(document).ready(function(){
        var isBasicSalary=document.getElementById("AhProll_is_basic_salary");
        var isProvidentFund=document.getElementById("AhProll_is_provident_fund");
        $(isBasicSalary).change(function(){
           if(isBasicSalary.checked){
               isProvidentFund.checked=false;
           }
        });
        $(isProvidentFund).change(function(){
           if(isProvidentFund.checked){
               isBasicSalary.checked=false;
           }
        });
    })
</script>
