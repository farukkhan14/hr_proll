...
<fieldset style="float: left; width: 98%;">
    ...
    $this->widget('ext.groupgridview.GroupGridView', array(
        ...
        'columns' => array(
            ...
            array(
                'name' => 'percentage_of_ah_proll_id',
                'value' => 'CHtml::encode(OtRate::model()->percengateAmount($data->percentage_of_ah_proll_id, $data->amount_adj))',
                'filter' => '',
