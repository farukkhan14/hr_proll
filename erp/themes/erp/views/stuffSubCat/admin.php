...
<fieldset style="float: left; width: 98%;">
    <legend>Manage Stuff Sub-Categories</legend>
    <?php
    $this->widget('ext.groupgridview.GroupGridView', array(
        'id' => 'stuff-sub-cat-grid',
        'dataProvider' => $model->search(),
        'mergeColumns' => array('stuff_cat_id'),
        'filter' => $model,
        'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview/styles.css',
        'columns' => array(
            array(
                'name'=>'stuff_cat_id',
                'value'=>'CHtml::encode(StuffCat::model()->nameOfThis($data->stuff_cat_id))',
                'filter'=>CHtml::listData(StuffCat::model()->findAll(), "id", "title"),
            ),
            'title',
            array
                (
