...
<fieldset style="float: left; width: 98%;">
    <legend>Manage Sub-Sections</legend>
    <?php
    $this->widget('ext.groupgridview.GroupGridView', array(
        'id' => 'sections-sub-grid',
        'dataProvider' => $model->search(),
        'mergeColumns' => array('section_id'),
        'filter' => $model,
        'cssFile' => Yii::app()->theme->baseUrl . '/css/gridview/styles.css',
        'columns' => array(
            array(
                'name'=>'section_id',
                'value'=>'CHtml::encode(Sections::model()->nameOfThis($data->section_id))',
                'filter'=>CHtml::listData(Sections::model()->findAll(), "id", "title"),
            ),
            'title',
            array
                (
