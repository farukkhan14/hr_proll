...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'adv_pay_type'); ?>
		<?php echo $form->textField($model,'adv_pay_type'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'recv_amount'); ?>
		<?php echo $form->textField($model,'recv_amount'); ?>
	</div>
