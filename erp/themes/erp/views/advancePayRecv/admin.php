...
<fieldset style="float: left; width: 98%;">
    <legend>Manage Advance Paid/Received</legend>
    <?php
    $this->widget('ext.groupgridview.GroupGridView', array(
        'id' => 'advance-pay-recv-grid',
        ...
        'columns' => array(
            ...
            array(
                'name' => 'payOrReceive',
                'value' => 'Lookup::item("payOrReceive", $data->payOrReceive)',
                'filter' => Lookup::items('payOrReceive'),
            ),
            array(
                'name' => 'adv_pay_type',
                'value' => 'Lookup::item("adv_pay_type", $data->adv_pay_type)',
                'filter' => Lookup::items('adv_pay_type'),
            ),
            'installment',
            'interest',
            'amount',
            ...
            array(
                'name' => 'is_approved',
                'value' => 'CHtml::encode(AdvancePayRecv::model()->statusColor($data->is_approved))',
