<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('adv_pay_type')); ?>:</b>
	<?php echo CHtml::encode($data->adv_pay_type); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('recv_amount')); ?>:</b>
	<?php echo CHtml::encode($data->recv_amount); ?>
	<br />
